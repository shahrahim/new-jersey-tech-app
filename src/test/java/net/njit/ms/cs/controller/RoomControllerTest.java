...
//
//        ResponseEntity<List<RoomResponse>> foundRoomList = this.roomController.getAllRooms();
...
//
//        ResponseEntity<RoomResponse> foundRoom = this.roomController.getRoomById(ROOM_NUMBER);
//        try(AutoCloseableSoftAssertions softly = new AutoCloseableSoftAssertions()) {
...
//            softly.assertThat(foundRoom.getBody().getBuildingNumber()).isEqualTo(BUILDING_NUMBER);
...
//
//        ResponseEntity<RoomResponse> foundRoom = this.roomController.getCreatedRoom(roomDto);
//        try(AutoCloseableSoftAssertions softly = new AutoCloseableSoftAssertions()) {
//            softly.assertThat(foundRoom).isNotNull();
//            softly.assertThat(foundRoom.getBody()).isNotNull();
//            softly.assertThat(foundRoom.getBody().getRoomNumber()).isEqualTo(ROOM_NUMBER);
...
//
//        ResponseEntity<RoomResponse> foundRoom = this.roomController.getUpdatedRoom(ROOM_NUMBER, roomDto);
//        try(AutoCloseableSoftAssertions softly = new AutoCloseableSoftAssertions()) {
//            softly.assertThat(foundRoom).isNotNull();
//            softly.assertThat(foundRoom.getBody()).isNotNull();
//            softly.assertThat(foundRoom.getBody().getRoomNumber()).isEqualTo(ROOM_NUMBER);
